...
router.delete('/delete/:bulletInId', async function (req, res) {
...
router.get('/getBulletin/:id', async function (req, res) {
  try {
...
router.get('/getAllBulletins', async function (req, res) {
  try {
